"""
Multi-strategy example DAG using the Airflow Backtest Framework.
"""
...
config1 = BacktestConfig(
    ...
    param_grid={
        ...
        'rebalance_period': [1],
        'strategy_params': [
            {'long_pct': 0.2, 'short_pct': 0.2, 'max_position_size': 0.05}
        ]
    },
...
# Create multi-strategy DAG using the factory
dag = BacktestDAGFactory.create_multi_strategy_dag(
    configs=[config1, config2],
    dag_id='framework_backtest_multi_example',
    default_args=default_args,
    tags=['example', 'framework', 'backtest', 'multi-strategy'],
    description='Multi-strategy example DAG using the Airflow Backtest Framework',
